...
!+++ARH
   call addfld('WSUB_DIAG', (/ 'lev' /), 'A', 'm/s', 'Diagnostic sub-grid vertical velocity (before scaling)'  )
!---ARH
...
!+++ARH
   wsubtmp(:ncol,:top_lev-1) = wsub(:ncol,:top_lev-1)
!---ARH
   do k = top_lev, pver
      do i = 1, ncol
...
!+++ARH
   call outfld('WSUB_DIAG',   wsubtmp, pcols, lchnk)
!---ARH
