...
!xxx       kord_tr_cslam(thermodynamic_active_species_idx(m)) = vert_remap_uvTq_alg
!xxx       kord_tr(m)                                 = vert_remap_uvTq_alg
...
!xxx         kord_tr(thermodynamic_active_species_idx_dycore(m)) = vert_remap_uvTq_alg
       end if
