...
module parameters_tunable
  ...
  subroutine set_default_parameters( &
    ...
    C1c         = 0.750000_core_rknd ! Degree of Slope of C1 Skw. Function [-]
    ...
    C6rtc       = 0.500000_core_rknd ! Degree of Slope of C6rt Skw. Fnct.  [-]
    C6thl       = 2.000000_core_rknd ! Low Skewness in C6thl Skw. Function [-]
    C6thlb      = 2.000000_core_rknd ! High Skewness in C6thl Skw. Fnct.   [-]
    C6thlc      = 0.500000_core_rknd ! Degree of Slope of C6thl Skw. Fnct. [-]
    ...
    C11c        = 0.850000_core_rknd ! Degree of Slope of C11 Skw. Fnct.   [-]
    ...
    gamma_coefc = 1.200000_core_rknd ! Deg. Slope: gamma coef. Skw. Fnct. [-]
    mu          = 5.000E-4_core_rknd ! Fract entrain rate per unit alt  [1/m]
    ...
    nu1   = 10.00000_core_rknd ! Bg. Coef. Eddy Diffusion: wp2        [m^2/s]
    ...
    C_invrs_tau_wpxp_Ri        = 3.0_core_rknd
    C_invrs_tau_wpxp_N2_thresh = 3.5e-4_core_rknd
    ...
    altitude_threshold = 150.0_core_rknd ! Altitude above which damping should occur for wpxp
    ...
    a3_coef_min = 1.6_core_rknd  ! Minimum threshold on the a3 coefficient
    a_const = 1.6_core_rknd ! Used in sfc_varnce_module.F90 to set surface values
    bv_efold = 1._core_rknd ! Control parameter for inverse e-folding of
                            ! cloud fraction in the mixed Brunt Vaisala frequency
    wpxp_Ri_exp = 1._core_rknd  ! Exponent determining the influence of
