...
# Created 2024-07-03 14:37:24

CASEDIR="/glade/campaign/cesm/cesmdata/cseg/runs/cesm2_0/f.e23_alpha17f.FLTHIST_ne30.099"
...
./xmlchange PROJECT=P993,RESUBMIT=5,STOP_N=2,STOP_OPTION=nyears

./xmlchange REST_OPTION=nyears,REST_N=1

./xmlchange CHARGE_ACCOUNT=P993
